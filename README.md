...
``javascript
//*
* Функция получает строку текста шутки Чака
* Если свойство api имеет аргумент, разбиваем строку на массив
* Далее ищем слова в справочнике и отдаем переведенный текст
*/
